...
class TimeKeeperClassVisitor extends ClassVisitor{

    def timeKeeperScopeEnum
    String className
     ...
     *     null.
     */
    TimeKeeperClassVisitor(int api, ClassVisitor classVisitor,TimeKeeperScopeEnum timeKeeperScopeEnum) {
    ...
    MethodVisitor visitMethod(int access, String name, String descriptor, String signature, String[] exceptions) {
        ...
        if (TimeKeeperGlobal.instance.ignoreMethod.contains(name)){

        }else {
            methodVisitor=new TimeKeeperAdviceAdapter(api,timeKeeperScopeEnum,className,methodVisitor,access,name,descriptor)
        }
